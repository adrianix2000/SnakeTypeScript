    ...
    private frame() {
        ...
        switch (this.direction) {
            case 'd':
                ...
                if (this.map.currentCoords.y < 0) this.map.currentCoords.y = this.map.height;
                break;
            case 'g':
                this.map.currentCoords.y++;
                if (this.map.currentCoords.y >= this.map.height) this.map.currentCoords.y = 0;
                break;
            case 'p':
                this.map.currentCoords.x++;
                if (this.map.currentCoords.x >= this.map.width) this.map.currentCoords.x = 0;
                break;
            case 'l':
                this.map.currentCoords.x--;
                if (this.map.currentCoords.x < 0) this.map.currentCoords.x = this.map.width;
                break;
        }
